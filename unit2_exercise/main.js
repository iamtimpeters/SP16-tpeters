// #4a
console.log("Hello, My name is TIM PETERS");
//#4b
...
//#5d
console.log("83.97 minus 34.86 equals " + (83.97 - 34.85));
//#5e
...
//#7s
console.log("The type of 'newNumber(\"some text\") is: " + typeof(new Number("some text")));
//#8a
var foo = 2;
var bar = 3;
//#8b
